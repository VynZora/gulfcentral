...
urlpatterns = [
    ...
    path("blog-messages/", views.view_blog_messages, name="view_blog_messages"),
    path("blog-messages/delete/<int:pk>/", views.delete_blog_message, name="delete_blog_message"),
